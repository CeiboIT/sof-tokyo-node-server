...
var email = [
    ...
    },
    {
        ...
        path: _prefix + '/new',
        handler: function (request, reply) {
            EmailService.sendNewEmail(request.payload.fromEmail, request.payload.fromName, request.payload.to, request.payload.subject, request.payload.content).then(function (data) {
                reply(data);
            });
        },
        config: {
